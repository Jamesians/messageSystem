...
<div class = "box_1">
    ...
    <div class = "sidemenu">
        <div class="menu">
            <div class="menuItem uno">1<a target="iframe_a" href="#">老师信息</a></div>
            <div class="menuItem dos">2<a target="iframe_a">选择开班</a></div>
            <div class="menuItem tres">3<a target="iframe_a" href="#">查看班级</a></div>
            <div class="menuItem cuatro">4<a target="iframe_a" href="#">录入成绩</a></div>
            <%--<div class="menuItem cinco">5<a target="iframe_a">期末成绩</a></div>--%>
        </div>
    </div>
    <div class = "main_content">
        <iframe class = "t2" src="#" name="iframe_a" frameborder="1" width="100%" height="800px" padding="100px">
        </iframe>
    </div>
</div>
<script>
